...
<template>
  <div class="container mx-auto px-4 py-8 bg-base-200">
    ...
    <p class="py-6 text-center text-lg text-neutral-content">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <RouterLink to="/books"
          ...
          <div class="card-body items-center text-center">
            ...
            <p class="text-neutral-content">Manage your book collection</p>
          </div>
        </RouterLink>
        ...
        <RouterLink to="/movies"
          ...
          <div class="card-body items-center text-center">
            ...
            <p class="text-neutral-content">Track movies you've watched</p>
          </div>
        </RouterLink>
        ...
        <RouterLink to="/series"
          ...
          <div class="card-body items-center text-center">
            ...
            <p class="text-neutral-content">Keep up with your favorite series</p>
          </div>
        </RouterLink>
      </div>
    </template>
