  ...
  <div class="card bg-base-100 shadow-xl border border-base-300">
    <div class="card-body">
      ...
      <div class="card bg-base-200 border border-base-300" v-if="showAddForm">
        <div class="card-body">
          <h3 class="card-title text-secondary">Add New Feed</h3>
          <form @submit.prevent="createFeed">
            ...
            <div class="form-control mb-4">
              <label class="label" for="rss">
                <span class="label-text text-base-content">RSS URL</span>
              </label>
              <input
                type="url"
                id="rss"
            ...
            <div class="flex justify-end gap-2 mt-4">
              ...
              <button type="submit" class="btn btn-primary text-primary-content">Save Feed</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="card bg-base-200 border border-base-300" v-if="showEditForm">
        <div class="card-body">
          <h3 class="card-title text-secondary">Edit Feed</h3>
          <form @submit.prevent="updateFeed">
            ...
            <div class="flex justify-end gap-2 mt-4">
              <button type="button" class="btn btn-ghost text-base-content" @click="cancelForm">Cancel</button>
              <button type="submit" class="btn btn-primary text-primary-content">Update Feed</button>
            </div>
          </form>
        </div>
      </div>
            ...
            <tr v-for="feed in feeds" :key="feed.id">
              ...
              <td>
                <div class="flex gap-2">
                  <button class="btn btn-sm btn-info text-info-content" @click="startEdit(feed)">Edit</button>
                  <button class="btn btn-sm btn-error text-error-content" @click="deleteFeed(feed.id)">Delete</button>
                </div>
              </td>
            </tr>
          </tbody>
